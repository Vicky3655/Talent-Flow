...
// Maps each role's extra fields (beyond name/email/bio) between the
// settings.html input id and the Firestore key student-profile.html /
// instructor-profile.html already use — this is what makes editing
// here update the exact same document those pages read and write.
const ROLE_FIELDS = {
    Instructor: [
...
async function loadProfileIntoSettings() {
    ...
    // Reveal and fill whichever role-specific fields apply
