...
const courses = [
    {
        ...
        desc: 'Learn the core principles of product design, from ideation to prototyping.',
        status: 'published',
        lessons: 10,
        notify: true,
        ...
        alt: 'Product Design',
        materials: [
            { name: 'Week 1 – Design Thinking.pdf', size: '2.4 MB', type: 'pdf' },
            { name: 'Prototype Templates.pptx', size: '5.1 MB', type: 'ppt' }
        ]
    },
    {
        id: 2,
        title: 'UI/UX Design Fundamentals',
        desc: 'Master user research, wireframing, and high-fidelity design using industry tools.',
        status: 'published',
        lessons: 12,
        notify: true,
        thumb: 'https://images.unsplash.com/photo-1581291518857-4e27b48ff24e?w=400&q=80',
        alt: 'UI/UX Design',
        materials: [
            { name: 'Color Theory.pdf', size: '1.8 MB', type: 'pdf' }
        ]
    },
    {
        id: 3,
        title: 'Frontend Development for Designers',
        desc: 'Bridge the gap between design and code with HTML, CSS, and JavaScript fundamentals.',
        status: 'draft',
        lessons: 9,
        notify: false,
        thumb: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=400&q=80',
        alt: 'Frontend Dev',
        materials: []
    },
    {
        ...
        desc: 'Transform raw data into meaningful insights using Python, pandas, and SQL queries.',
        status: 'published',
        lessons: 9,
        notify: true,
        ...
        alt: 'Data Analysis',
        materials: [
            { name: 'Python Cheatsheet.pdf', size: '820 KB', type: 'pdf' },
            { name: 'SQL Exercises.docx', size: '300 KB', type: 'doc' },
            { name: 'Dataset – Sales Q1.zip', size: '14 MB', type: 'zip' }
        ]
    },
    {
        id: 5,
        title: 'Introduction to Backend Development',
        desc: 'Build RESTful APIs and server-side logic with Node.js and Express.',
        status: 'draft',
        lessons: 11,
        notify: false,
    ...
    },
    {
        ...
        desc: 'Deploy scalable applications on AWS using EC2, S3, Lambda, and more.',
        status: 'published',
        lessons: 20,
        notify: true,
        ...
        alt: 'Cloud Computing',
        materials: [
            { name: 'AWS Architecture Guide.pdf', size: '6.3 MB', type: 'pdf' }
        ]
    }
];
...
function initDrawer() {
    ...
    drawerInput.addEventListener('change', () => {
        ...
        renderCourses();
        showToast('Files uploaded', `${drawerInput.files ? 1 : 0} file(s) added to "${course.title}".`, 'success');
    });
}
...
function removeDrawerFile(courseId, idx) {
