...
const STUDENTS = [
    { id: 1,  name: 'Amara Osei',        email: 'amara.osei@email.com',        avatar: 'https://i.pravatar.cc/40?img=1',  courses: [0,2,4], grade: 91, status: 'active',   last: '2 hours ago' },
    { id: 2,  name: 'Tunde Adeyemi',     email: 'tunde.adeyemi@email.com',     avatar: 'https://i.pravatar.cc/40?img=3',  courses: [1,3],   grade: 78, status: 'active',   last: '5 hours ago' },
    { id: 3,  name: 'Chisom Nwachukwu',  email: 'chisom.nwa@email.com',        avatar: 'https://i.pravatar.cc/40?img=5',  courses: [0,5],   grade: 55, status: 'at-risk',  last: '3 days ago'  },
    { id: 4,  name: 'Emeka Eze',         email: 'emeka.eze@email.com',         avatar: 'https://i.pravatar.cc/40?img=7',  courses: [2],     grade: 84, status: 'active',   last: '1 day ago'   },
    { id: 5,  name: 'Ngozi Okonkwo',     email: 'ngozi.okonkwo@email.com',     avatar: 'https://i.pravatar.cc/40?img=9',  courses: [0,1,3], grade: 96, status: 'active',   last: '30 min ago'  },
    { id: 6,  name: 'Bola Akinwande',    email: 'bola.akinwande@email.com',    avatar: 'https://i.pravatar.cc/40?img=11', courses: [4,5],   grade: 62, status: 'at-risk',  last: '6 days ago'  },
    { id: 7,  name: 'Seun Falola',       email: 'seun.falola@email.com',       avatar: 'https://i.pravatar.cc/40?img=13', courses: [1,2,4], grade: 88, status: 'active',   last: 'Yesterday'   },
    { id: 8,  name: 'Adaeze Chukwu',     email: 'adaeze.chukwu@email.com',     avatar: 'https://i.pravatar.cc/40?img=15', courses: [3,5],   grade: 45, status: 'inactive', last: '2 weeks ago' },
    { id: 9,  name: 'Kelechi Obiora',    email: 'kelechi.obiora@email.com',    avatar: 'https://i.pravatar.cc/40?img=17', courses: [0,2],   grade: 79, status: 'active',   last: '4 hours ago' },
    { id: 10, name: 'Funmi Babatunde',   email: 'funmi.babatunde@email.com',   avatar: 'https://i.pravatar.cc/40?img=19', courses: [1],     grade: 71, status: 'active',   last: '3 hours ago' },
    { id: 11, name: 'Ola Oladele',       email: 'ola.oladele@email.com',       avatar: 'https://i.pravatar.cc/40?img=21', courses: [2,3,5], grade: 93, status: 'active',   last: '1 hour ago'  },
    { id: 12, name: 'Yetunde Martins',   email: 'yetunde.m@email.com',         avatar: 'https://i.pravatar.cc/40?img=23', courses: [0,4],   grade: 58, status: 'at-risk',  last: '5 days ago'  },
    { id: 13, name: 'Damilola Adesanya', email: 'dami.adesanya@email.com',     avatar: 'https://i.pravatar.cc/40?img=25', courses: [1,3],   grade: 87, status: 'active',   last: 'Yesterday'   },
    { id: 14, name: 'Rotimi Coker',      email: 'rotimi.coker@email.com',      avatar: 'https://i.pravatar.cc/40?img=27', courses: [5],     grade: 42, status: 'inactive', last: '3 weeks ago' },
    { id: 15, name: 'Ifunanya Obi',      email: 'ifunanya.obi@email.com',      avatar: 'https://i.pravatar.cc/40?img=29', courses: [0,1,2], grade: 95, status: 'active',   last: '20 min ago'  },
    { id: 16, name: 'Gbenga Ogundimu',   email: 'gbenga.ogundimu@email.com',   avatar: 'https://i.pravatar.cc/40?img=31', courses: [2,4],   grade: 73, status: 'active',   last: '2 days ago'  },
    { id: 17, name: 'Aisha Musa',        email: 'aisha.musa@email.com',        avatar: 'https://i.pravatar.cc/40?img=33', courses: [3,5],   grade: 81, status: 'active',   last: '6 hours ago' },
    { id: 18, name: 'Chidi Nwankwo',     email: 'chidi.nwankwo@email.com',     avatar: 'https://i.pravatar.cc/40?img=35', courses: [0],     grade: 50, status: 'at-risk',  last: '4 days ago'  },
];
